...
let a = new HolidayPackage('Burgas', 'Spring');
a.insuranceIncluded = true;
a.addVacationer('Pesho Goshov');
a.addVacationer('Lala Lolo');
console.log(a.generateHolidayPackage());
